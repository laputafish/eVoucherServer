...
-- Dumping structure for table ticket_yoov_com.abilities
...
-- Dumping structure for table ticket_yoov_com.access_keys
...
-- Dumping structure for table ticket_yoov_com.agents
...
-- Dumping structure for table ticket_yoov_com.assigned_roles
...
-- Dumping structure for table ticket_yoov_com.medias
...
-- Dumping structure for table ticket_yoov_com.menus
...
-- Dumping structure for table ticket_yoov_com.migrations
...
-- Dumping structure for table ticket_yoov_com.oauth_access_tokens
...
-- Dumping structure for table ticket_yoov_com.oauth_auth_codes
...
-- Dumping structure for table ticket_yoov_com.oauth_clients
...
-- Dumping structure for table ticket_yoov_com.oauth_personal_access_clients
...
-- Dumping structure for table ticket_yoov_com.oauth_refresh_tokens
...
-- Dumping structure for table ticket_yoov_com.password_resets
...
-- Dumping structure for table ticket_yoov_com.permissions
...
-- Dumping structure for table ticket_yoov_com.roles
...
-- Dumping structure for table ticket_yoov_com.system
...
-- Dumping structure for table ticket_yoov_com.template_keys
...
-- Dumping structure for table ticket_yoov_com.temp_leaflets
...
-- Dumping structure for table ticket_yoov_com.users
...
-- Dumping structure for table ticket_yoov_com.user_verifications
...
-- Dumping structure for table ticket_yoov_com.vouchers
...
-- Dumping structure for table ticket_yoov_com.voucher_codes
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34191 DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.

-- Dumping structure for table ticket_yoov_com.voucher_code_configs
CREATE TABLE IF NOT EXISTS `voucher_code_configs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4055 DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.

-- Dumping structure for table ticket_yoov_com.voucher_emails
