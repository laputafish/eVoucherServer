...
CREATE TABLE IF NOT EXISTS `medias` (
  ...
  `scope` enum('tinymce','general') NOT NULL DEFAULT 'general',
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `sharing_title` varchar(191) DEFAULT '0',
  `sharing_description` varchar(191) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `voucher_codes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5932 DEFAULT CHARSET=utf8mb4;
